...
<body class="d-flex flex-column min-vh-100">
  ...
  <!-- Contenido Principal (Simplificado con bg-warning de ancho completo) -->
  <main class="container-fluid bg-warning py-5 text-center flex-grow-1">
    <h1 class="display-4 fw-bold">Bienvenido a MiEmpresa</h1>
    <p class="lead">Esta es la página de inicio para el entregable de la Semana 2.</p>
    <p>Diseño responsivo utilizando el Grid System de Bootstrap 5.</p>
  </main>
  ...
  <!-- Bootstrap 5 JS Bundle (Requerido para el funcionamiento del menú y modal, sin JS propio) -->
