...
<body class="d-flex flex-column min-vh-100">
  ...
  <!-- Contenido Principal: Empresa (Simplificado con bg-warning de ancho completo sin bordes) -->
  <main class="container-fluid bg-warning py-5 flex-grow-1">
    <div class="row text-center">
      ...
      <div class="col-md-4 mb-3">
        <h3>Quiénes Somos</h3>
        <p>Somos una empresa dedicada al desarrollo de software y soluciones web responsivas.</p>
      </div>
      <div class="col-md-4 mb-3">
        <h3>Nuestro Equipo</h3>
        <p>Contamos con un equipo de profesionales comprometidos con la usabilidad y el rendimiento.</p>
      </div>
      <div class="col-md-4 mb-3">
        <h3>Misión</h3>
        <p>Ofrecer productos tecnológicos completos, suficientes y verificables bajo los estándares de la industria.</p>
      </div>
    </div>
