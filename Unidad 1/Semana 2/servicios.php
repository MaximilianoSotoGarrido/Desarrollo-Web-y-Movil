...
<head>
  ...
  <title>MiEmpresa - Servicios</title>
  <!-- Bootstrap 5 CSS -->
...
<body class="d-flex flex-column min-vh-100">
  ...
  <!-- Contenido Principal: Servicios (Simplificado con bg-warning de ancho completo sin bordes) -->
  <main class="container-fluid bg-warning py-5 flex-grow-1">
    <div class="row text-center">
      ...
      <div class="col-md-6 mb-3">
        ...
        <p>Analizamos las necesidades de tu negocio y diseñamos soluciones robustas.</p>
      </div>
      <div class="col-md-6 mb-3">
        <h3>Desarrollo Web Responsivo</h3>
        <p>Creamos sitios dinámicos utilizando Bootstrap 5 y buenas prácticas de usabilidad.</p>
      </div>
    </div>
